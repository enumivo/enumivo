...
class multi_index
{
   ...
   public:
       ...
       *      typedef enumivo::multi_index< N(address), address > address_index;
       *      void myaction() {
       *        address_index addresses(N(aiden), N(aiden)); // code, scope
       *        enumivo_assert(addresses.get_code() == N(aiden), "Codes don't match.");
       *      }
       *  }
       *  ENUMIVO_ABI( addressbook, (myaction) )
       *  @endcode
       ...
       *      void myaction() {
       *        address_index addresses(N(aiden), N(aiden)); // code, scope
       *        enumivo_assert(addresses.get_code() == N(aiden), "Scopes don't match");
       *      }
       *  }
       *  ENUMIVO_ABI( addressbook, (myaction) )
       *  @endcode
       ...
       *          address.state = "EM";
       *        });
       *        auto itr = addresses.find(N(aiden));
       ...
       *        enumivo_assert(itr->account_name == N(aiden), "Incorrect Last Record ");
       *        itr++;
       ...
       *        itr--;
       *        enumivo_assert(itr->account_name == N(aiden), "Incorrect Second Record");
       *      }
       *  }
       *  ENUMIVO_ABI( addressbook, (myaction) )
       *  @endcode
       ...
       *        itr++;
       *        enumivo_assert(itr->account_name == N(aiden), "Incorrect Second Lower Bound Record");
       *        itr++;
       ...
       *        enumivo_assert(itr->account_name == N(aiden), "Incorrect First Upper Bound Record ");
       *        itr++;
       *        enumivo_assert(itr == zip_index.end(), "Incorrect End of Iterator");
       *      }
       *  }
       ...
       *          address.zip = 14344;
       *        });
       *        uint32_t zipnumb = 14344;
       *        auto zip_index = addresses.get_index<N(zip)>();
       *        auto itr = zip_index.find(zipnumb);
       *        enumivo_assert(itr->account_name == N(aiden), "Incorrect Record ");
       *      }
       *  }
       *  ENUMIVO_ABI( addressbook, (myaction) )
       *  @endcode
       ...
       *          address.zip = 93445;
       *        });
       *        auto user = addresses.get(N(aiden));
       *        auto itr = address.find(N(aiden));
