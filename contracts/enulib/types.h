 ...
 * @details Enumivo Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief Enumivo Signature
 * @details Enumivo Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of Enumivo Transaction Id
 * @details Type of Enumivo Transaction Id. It is 256-bit hash
 */
