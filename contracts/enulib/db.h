 ...
 *  @brief Defines an interface to Enumivo database
 *  @ingroup database
 *
 *  @details
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to Enumivo database.
 *
...
/**
  ...
  *  enumivo_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  enumivo_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  enumivo_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
