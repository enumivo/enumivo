...
struct integration_test : public enumivo::contract {
      ...
      typedef enumivo::multi_index<N(payloads), payload> payloads;
      ...
      void store( account_name from,
         ...
         enumivo_assert( num < std::numeric_limits<size_t>::max(), "num to large");
...
ENUMIVO_ABI( integration_test, (store) )
