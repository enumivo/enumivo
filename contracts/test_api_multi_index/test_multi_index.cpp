...
namespace _test_multi_index {
   ...
   void idx64_check_without_storing(uint64_t receiver)
   {
      ...
      // find by primary key
      {
         ...
         enumivo_assert(itr != table.end() && itr->sec == N(emily), "idx64_general - table.require_find() of existing primary key");
      ...
      // require_find secondary key
      {
         ...
         enumivo_assert(itr != secondary_index.end(), "idx64_general - require_find must never return end iterator");
         enumivo_assert(itr->id == 540, "idx64_general - require_find test");
         
         ++itr;
         enumivo_assert(itr->id == 781, "idx64_general - require_find secondary key test");
      }
   ...
   void idx64_require_find_fail(uint64_t receiver)
   {
      ...
      enumivo_assert(itr != table.end(), "table not loaded");
   ...
   void idx64_require_find_sk_fail(uint64_t receiver)
   {
      ...
      enumivo_assert(itr != sec_index.end(), "table not loaded");
