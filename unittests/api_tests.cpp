...
#warning re-enable deferred transaction replacement test after bug has been fixed
...

   {
      ...
      // But not anymore. Now it should subjectively fail because testapi@additional permission is not unilaterally satisfied by testapi@enumivo.code.
      dtt_action dtt_act3;
