...
void test_crypto::test_sha1() {
   enumivo::checksum160 tmp;

   tmp = enumivo::sha1( test1, my_strlen(test1) );
   enumivo_assert( my_memcmp((void *)test1_ok_1, &tmp, sizeof(enumivo::checksum160)), "sha1 test1" );

   tmp = enumivo::sha1( test3, my_strlen(test3) );
   enumivo_assert( my_memcmp((void *)test3_ok_1, &tmp, sizeof(enumivo::checksum160)), "sha1 test3" );

   tmp = enumivo::sha1( test4, my_strlen(test4) );
   enumivo_assert( my_memcmp((void *)test4_ok_1, &tmp, sizeof(enumivo::checksum160)), "sha1 test4" );

   tmp = enumivo::sha1( test5, my_strlen(test5) );
   enumivo_assert( my_memcmp((void *)test5_ok_1, &tmp, sizeof(enumivo::checksum160)), "sha1 test5" );
}

void test_crypto::test_sha256() {
  enumivo::checksum256 tmp;

  tmp = enumivo::sha256( test1, my_strlen(test1) );
  enumivo_assert( my_memcmp((void *)test1_ok_256, &tmp, sizeof(enumivo::checksum256)), "sha256 test1" );

  tmp = enumivo::sha256( test3, my_strlen(test3) );
  enumivo_assert( my_memcmp((void *)test3_ok_256, &tmp, sizeof(enumivo::checksum256)), "sha256 test3" );

  tmp = enumivo::sha256( test4, my_strlen(test4) );
  enumivo_assert( my_memcmp((void *)test4_ok_256, &tmp, sizeof(enumivo::checksum256)), "sha256 test4" );

  tmp = enumivo::sha256( test5, my_strlen(test5) );
  enumivo_assert( my_memcmp((void *)test5_ok_256, &tmp, sizeof(enumivo::checksum256)), "sha256 test5" );
}

void test_crypto::test_sha512() {
  enumivo::checksum512 tmp;

  tmp = enumivo::sha512( test1, my_strlen(test1) );
  enumivo_assert( my_memcmp((void *)test1_ok_512, &tmp, sizeof(enumivo::checksum512)), "sha512 test1" );

  tmp = enumivo::sha512( test3, my_strlen(test3) );
  enumivo_assert( my_memcmp((void *)test3_ok_512, &tmp, sizeof(enumivo::checksum512)), "sha512 test3" );

  tmp = enumivo::sha512( test4, my_strlen(test4) );
  enumivo_assert( my_memcmp((void *)test4_ok_512, &tmp, sizeof(enumivo::checksum512)), "sha512 test4" );

  tmp = enumivo::sha512( test5, my_strlen(test5) );
  enumivo_assert( my_memcmp((void *)test5_ok_512, &tmp, sizeof(enumivo::checksum512)), "sha512 test5" );
}

void test_crypto::test_ripemd160() {
  enumivo::checksum160 tmp;

  tmp = enumivo::ripemd160( test1, my_strlen(test1) );
  enumivo_assert( my_memcmp((void *)test1_ok_ripe, &tmp, sizeof(enumivo::checksum160)), "ripemd160 test1" );

  tmp = enumivo::ripemd160( test3, my_strlen(test3) );
  enumivo_assert( my_memcmp((void *)test3_ok_ripe, &tmp, sizeof(enumivo::checksum160)), "ripemd160 test3" );

  tmp = enumivo::ripemd160( test4, my_strlen(test4) );
  enumivo_assert( my_memcmp((void *)test4_ok_ripe, &tmp, sizeof(enumivo::checksum160)), "ripemd160 test4" );

  tmp = enumivo::ripemd160( test5, my_strlen(test5) );
  enumivo_assert( my_memcmp((void *)test5_ok_ripe, &tmp, sizeof(enumivo::checksum160)), "ripemd160 test5" );
}

void test_crypto::sha256_null() {
  enumivo::checksum256 tmp;
  tmp = enumivo::sha256( nullptr, 100);
...
void test_crypto::sha1_no_data() {
  ...
  tmp = enumivo::sha1( test2, my_strlen(test2) );
  enumivo_assert( my_memcmp((void *)test2_ok_1, &tmp, sizeof(enumivo::checksum160)), "sha1 test2" );
}

void test_crypto::sha256_no_data() {
  enumivo::checksum256 tmp;

  tmp = enumivo::sha256( test2, my_strlen(test2) );
  enumivo_assert( my_memcmp((void *)test2_ok_256, &tmp, sizeof(enumivo::checksum256)), "sha256 test2" );
}

void test_crypto::sha512_no_data() {
  enumivo::checksum512 tmp;

  tmp = enumivo::sha512( test2, my_strlen(test2) );
  enumivo_assert( my_memcmp((void *)test2_ok_512, &tmp, sizeof(enumivo::checksum512)), "sha512 test2" );
}

void test_crypto::ripemd160_no_data() {
  enumivo::checksum160 tmp;

  tmp = enumivo::ripemd160( test2, my_strlen(test2) );
  enumivo_assert( my_memcmp((void *)test2_ok_ripe, &tmp, sizeof(enumivo::checksum160)), "ripemd160 test2" );
}
