...
proxy::proxy( enumivo::name self, enumivo::name first_receiver, enumivo::datastream<const char*> ds )
...
void proxy::on_error( uint128_t sender_id, enumivo::ignore<std::vector<char>> ) {
