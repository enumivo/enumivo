...
transaction enu_msig_tester::reqauth( account_name from, const vector<permission_level>& auths, const fc::microseconds& max_serialization_time ) {
   fc::variants v;
...
BOOST_FIXTURE_TEST_CASE( big_transaction, enu_msig_tester ) try {
   ...
   auto wasm = wast_to_wasm( enu_token_wast );
