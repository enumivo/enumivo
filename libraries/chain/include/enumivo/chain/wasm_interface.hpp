   ...
   namespace webassembly { namespace common {
      ...
      try {
         ...
         if(validating && mod_name != "env")
            ENU_ASSERT( false, wasm_exception, "importing from module that is not 'env': ${module}.${export}", ("module",mod_name)("export",export_name) );
         ...
         ENU_ASSERT( false, wasm_exception, "${module}.${export} unresolveable", ("module",mod_name)("export",export_name) );
         return false;
...
FC_REFLECT_ENUM( enumivo::chain::wasm_interface::vm_type, (wavm)(wabt) )
