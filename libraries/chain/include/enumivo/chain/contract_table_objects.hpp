...
FC_REFLECT(enumivo::chain::table_id_object, (code)(scope)(table)(payer)(count) )
FC_REFLECT(enumivo::chain::key_value_object, (primary_key)(payer)(value) )

#define REFLECT_SECONDARY(type)\
  FC_REFLECT(type, (primary_key)(payer)(secondary_key) )

REFLECT_SECONDARY(enumivo::chain::index64_object)
REFLECT_SECONDARY(enumivo::chain::index128_object)
REFLECT_SECONDARY(enumivo::chain::index256_object)
REFLECT_SECONDARY(enumivo::chain::index_double_object)
REFLECT_SECONDARY(enumivo::chain::index_long_double_object)
