...
class Node(object):
    ...
    def getAccountEnuBalanceStr(self, scope):
        """Returns SYS currency0000 account balance from enucli get table command. Returned balance is string following syntax "98.0311 SYS". """
        assert isinstance(scope, str)
        if not self.enableMongo:
    ...
    def getAccountEnuBalance(self, scope):
        """Returns SYS currency0000 account balance from enucli get table command. Returned balance is an integer e.g. 980311. """
