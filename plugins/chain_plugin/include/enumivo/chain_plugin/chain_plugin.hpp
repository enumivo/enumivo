...
FC_REFLECT( enumivo::chain_apis::read_only::get_table_rows_params, (json)(code)(scope)(table)(table_key)(lower_bound)(upper_bound)(limit)(key_type)(index_position)(encode_type)(reverse)(show_payer) )
FC_REFLECT( enumivo::chain_apis::read_only::get_table_rows_result, (rows)(more) );

FC_REFLECT( enumivo::chain_apis::read_only::get_table_by_scope_params, (code)(table)(lower_bound)(upper_bound)(limit)(reverse) )
FC_REFLECT( enumivo::chain_apis::read_only::get_table_by_scope_result_row, (code)(scope)(table)(payer)(count));
FC_REFLECT( enumivo::chain_apis::read_only::get_table_by_scope_result, (rows)(more) );
...
FC_REFLECT_EMPTY( enumivo::chain_apis::read_only::get_producer_schedule_params )
FC_REFLECT( enumivo::chain_apis::read_only::get_producer_schedule_result, (active)(pending)(proposed) );

FC_REFLECT( enumivo::chain_apis::read_only::get_scheduled_transactions_params, (json)(lower_bound)(limit) )
FC_REFLECT( enumivo::chain_apis::read_only::get_scheduled_transactions_result, (transactions)(more) );
...
FC_REFLECT( enumivo::chain_apis::read_only::get_code_hash_results, (account_name)(code_hash) )
FC_REFLECT( enumivo::chain_apis::read_only::get_abi_results, (account_name)(abi) )
FC_REFLECT( enumivo::chain_apis::read_only::get_account_params, (account_name)(expected_core_symbol) )
FC_REFLECT( enumivo::chain_apis::read_only::get_code_params, (account_name)(code_as_wasm) )
FC_REFLECT( enumivo::chain_apis::read_only::get_code_hash_params, (account_name) )
FC_REFLECT( enumivo::chain_apis::read_only::get_abi_params, (account_name) )
FC_REFLECT( enumivo::chain_apis::read_only::get_raw_code_and_abi_params, (account_name) )
FC_REFLECT( enumivo::chain_apis::read_only::get_raw_code_and_abi_results, (account_name)(wasm)(abi) )
FC_REFLECT( enumivo::chain_apis::read_only::get_raw_abi_params, (account_name)(abi_hash) )
FC_REFLECT( enumivo::chain_apis::read_only::get_raw_abi_results, (account_name)(code_hash)(abi_hash)(abi) )
